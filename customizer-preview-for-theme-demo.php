	...
	if ( ! class_exists( 'Customizer_Preview_For_Theme_Demo' ) ):
		...
		class Customizer_Preview_For_Theme_Demo {
			...
			public function add_admin_menu() {
				add_options_page( esc_html__( 'Customizer Preview Settings', 'customizer-preview-for-theme-demo' ), esc_html__( 'Customizer Preview', 'customizer-preview-for-theme-demo' ), 'manage_options', CPTD_PLUGIN_DIRNAME, array( $this, 'show_settings_form' ) );
			}
			...
			public function show_settings_form() {
				...
				if ( ! current_user_can( 'manage_options' ) ) {
					wp_die( '<h1>' . esc_html__( 'Cheatin&#8217; uh?', 'customizer-preview-for-theme-demo' ) . '</h1>' . '<p>' . esc_html__( 'You are not allowed to this section.', 'customizer-preview-for-theme-demo' ) . '</p>', 403 );
				}
			...
			public function add_admin_settings() {
				...
				add_settings_field( 'button_text', // id
				                    'Button Text', // title
				...
				add_settings_field( 'button_link', // id
				                    'Button Link', // title
				...
				add_settings_field( 'button_target', // id
