<?php
	...
	require_once( ABSPATH . 'wp-admin/admin.php' );  //  REMEMBER
...
?>
<style type="text/css">
	#customizer-preview-notice.customize-info {
		border-bottom : none;
		}

	#customizer-preview-notice span {
		color : #f01d2e;
		}
</style>
</head>
...
<div class="wp-full-overlay expanded">
	<form id="customize-controls" class="wrap wp-full-overlay-sidebar">
		<div id="customize-header-actions" class="wp-full-overlay-header">
			<?php do_action( 'customizer_preview_header' ) ?>
